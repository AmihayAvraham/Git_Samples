...
namespace MoreMountains.TopDownEngine
{
	...
	public class Health : MonoBehaviour
	{
        ...
        // hit delegate
        public delegate void OnHitDelegate(GameObject hitter);
        ...
        // death delegate
		public delegate void OnDeathDelegate(DamageType deathType);
		...
		public virtual void Damage(int damage, GameObject instigator, float flickerDuration, float invincibilityDuration, Vector3 damageDirection, DamageType damageType)
		{
